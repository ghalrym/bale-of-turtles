...
class ChatTurtle(TurtleTool):
    ...
    @use_state('llm-message-changed', ['turtle_human_message', 'turtle_ai_message', 'turtle_system_message'])
    def message_added(
        self,
        ...
        **kwargs
        ...
        message = next(filter(None, [turtle_human_message, turtle_ai_message, turtle_system_message]), None)
